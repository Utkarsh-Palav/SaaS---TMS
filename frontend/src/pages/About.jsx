...
const About = () => {
  ...
  return (
    <ReactLenis root options={{ lerp: 0.05, smoothWheel: true }}>
      <div
        ref={containerRef}
        className="min-h-screen flex flex-col bg-[#0e100f] text-white font-sans selection:bg-[#3b82f6] selection:text-white overflow-x-hidden"
      >
        <Navbar />
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 relative">
            ...
            <p className="text-lg md:text-2xl text-slate-400 max-w-3xl mx-auto mb-16 font-medium leading-relaxed hero-image">
              Taskify started with a simple idea: Work shouldn't be chaotic. We
              are on a mission to simplify collaboration for teams of all sizes.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto h-[400px] md:h-[450px] hero-image">
              <div className="col-span-2 row-span-2 rounded-[2rem] overflow-hidden relative group border border-white/10">
                <img
                  ...
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 mix-blend-luminosity group-hover:mix-blend-normal"
                />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 md:mb-24">
              ...
              <p className="text-lg md:text-xl text-slate-400 font-medium max-w-2xl mx-auto">
                We believe that great software is built by teams who care about
                the details. These principles guide every decision we make.
              </p>
            </div>
        ...
        <section className="py-24 md:py-32 bg-[#0e100f] border-t border-white/5">
          <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 md:mb-24">
              ...
              <p className="text-lg md:text-xl text-slate-400 font-medium max-w-2xl mx-auto">
                The dreamers, designers, and developers building the future of
                work.
              </p>
            </div>
            ...
            <div className="flex items-center justify-center">
              <TeamMember
                ...
                linkedIn_url="https://www.linkedin.com/in/utkarsh-palav/"
                twitter_url="https://x.com/PalavUtkar65568"
              />
              {/* <TeamMember 
                 name="Sarah Williams" 
        ...
        <section className="py-24 md:py-32 px-4 relative overflow-hidden bg-[#0e100f] border-t border-white/10 z-20">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10 py-6 md:py-10">
            <h2 className="text-[4rem] md:text-[8rem] font-black text-white mb-8 tracking-tighter leading-none uppercase drop-shadow-lg">
              ...
              <span className="text-[#3b82f6]">Movement.</span>
            </h2>
            ...
            <div className="flex justify-center mt-10 md:mt-16">
              <Link
                to="/registration"
                className="w-full sm:w-auto px-8 py-5 md:px-12 md:py-6 text-xl md:text-2xl font-black text-black bg-[#0ae448] rounded-full hover:bg-white shadow-[0_0_40px_rgba(10,228,72,0.3)] transition-all hover:scale-105 flex items-center justify-center gap-3 group"
              >
                Start your trial{" "}
                <ArrowRight
...
const StatItem = ({ number, label, color }) => (
  <div className="stat-item p-4 border-l border-white/10 first:border-0">
    <div
      className={`text-4xl md:text-6xl font-black ${color} mb-2 tracking-tighter`}
    >
      {number}
    </div>
...
const ValueCard = ({ icon, title, desc, color, hoverBorder }) => (
  <div
    className={`value-card p-8 rounded-[2rem] border-2 border-white/5 bg-[#1c1c1c] ${hoverBorder} hover:shadow-2xl transition-all duration-300 text-left group cursor-default`}
  >
    <div
      className={`mb-6 ${color} transition-transform transform group-hover:scale-110 origin-left duration-300`}
    >
      {icon}
    </div>
...
const TeamMember = ({
  ...
  <div
    className={`team-card group relative bg-[#1c1c1c] p-4 rounded-[2rem] border-2 border-white/5 ${hoverBorder} transition-all text-center`}
  >
    <div className="w-full aspect-square rounded-[1.5rem] overflow-hidden mb-6 relative">
      ...
      <div
        className={`absolute inset-0 ${overlayColor} opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4`}
      >
        <a
          href={linkedIn_url}
          target="blank"
